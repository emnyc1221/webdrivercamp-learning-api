...
def find_mismatched_data(url, file_data):
    ...
    for planet in api_data:
        ...
        for expected_planet in file_data['results']:
            if expected_planet['name'] == planet_name:
                for key in planet:
                    if planet[key] != expected_planet[key]:
                        if planet_name not in mismatches:
                            mismatches[planet_name] = []
                        mismatches[planet_name].append({key: {'Expected': expected_planet[key], 'Actual': planet[key]}})
                break
...
if __name__ == "__main__":
    ...
    pprint(find_mismatched_data(url, file_data))
